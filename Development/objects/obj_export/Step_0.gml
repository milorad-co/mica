...
if global.selected == 4 and wordstring != "That file already exists.\n" and wordstring != "GUMP only supports saving .png, .jpg, and .jpeg file formats.\n"
{
	...
	if keyboard_check_pressed(vk_enter)
	{
		...
		else
		{
			...
			if filename_ext(wordstring) != ".png" and filename_ext(wordstring) != ".jpg" and filename_ext(wordstring) != ".jpeg"
			{
				wordstring = "GUMP only supports saving .png, .jpg, and .jpeg file formats.\n"
				alarm_set(0, 90);
			}
			else
			{
